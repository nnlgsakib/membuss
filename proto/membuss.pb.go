// Phase 4 wire schema for the libp2p-based PEX gossip protocol
// and the CLI <-> daemon gRPC service.
...
const file_membuss_proto_rawDesc = "" +
	...
	"\n" +
	"PEXMessage\x12*\n" +
	"\x05peers\x18\x01 \x03(\v2\x14.membuss.v1.PeerInfoR\x05peers2A\n" +
	"\x04Node\x129\n" +
...
var file_membuss_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_membuss_proto_depIdxs = []int32{
	...
	0, // 1: membuss.v1.Node.Ping:input_type -> membuss.v1.PingRequest
	1, // 2: membuss.v1.Node.Ping:output_type -> membuss.v1.PingResponse
